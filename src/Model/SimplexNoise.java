...
public class SimplexNoise {  // Simplex noise in 2D, 3D and 4D
    ...
    private static short pbak[] = {151,160,137,91,90,15,
    ...
    public static float[][] generateOctavedSimplexNoise(int width, int height, int octaves, float roughness, float scale, short seed){
